...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { email: @login.email, mobile_no: @login.mobile_no, name: @login.name, password: @login.password }
    end
  ...
  test "should update login" do
    put :update, id: @login, login: { email: @login.email, mobile_no: @login.mobile_no, name: @login.name, password: @login.password }
    assert_redirected_to login_path(assigns(:login))
  end
